...
class ListNetwork extends StatefulWidget {
  final idprograma;
  final title;
  ListNetwork(this.idprograma,this.title);

  /*@override
  createState() => _ListParticipanteState(this.idprograma,this.title);*/
  @override
  _ListNetworkState createState() => _ListNetworkState(this.idprograma,this.title);
}
...
class _ListNetworkState extends State<ListNetwork> {
  ...
  _ListNetworkState(this._idprograma,this._title);
  @override
  void initState() {
    super.initState();
    _isLoadingPage = true;
  ...
  Future<List<Job2>> _fetchJobs2(int idprog) async {
    ...
    final jobsListAPIUrl2 = 'https://admin.proexplo.com.pe/rest/getred';
